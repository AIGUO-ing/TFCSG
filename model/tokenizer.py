...
class Tokenizer(BasicTokenizer):
    ...
    def __init__(self, token_dict):
        ...
        for token in ['pad', 'cls', 'sep', 'unk', 'mask', 'space']:
            try:
                ...
                pass
        self._token_dict[getattr(self, "_token_space")] = self._token_dict.pop("[unused99]")
    ...
    def _is_space(ch):
        """空格类字符判断
        """
        return ch == ' ' or ch == '\n' or ch == '\xa0' or ch == '\u3000' or ch == '\r' or ch == '\t' or \
...
if __name__ == "__main__":
    vocab_path = "/home/ai/yangwei/myResources/chinese_roberta_wwm_base_ext_pytorch/vocab.txt"
    ...
    # print(text)
    # print(segment_ids)
    # 正确的编码：[CLS] x1 x2...xn [SEP] y1 y2...yn [SEP]
    print(tokenizer.encode(first_text="  今\n天天气真好啊\n  ", second_text="天气还好", max_length=20))
